 ...
 * Arquivo: sync-tse.php
 * ---------------------------------------------------------------------
 * Autor: Leonardo Nascimento
 * E-mail: oi@bewweb.com.br
 * ---------------------------------------------------------------------
 * Data da criação: 13/11/2020 9:40:49 pm
 * Last Modified:  13/11/2020 11:55:01 pm
...
if(empty($_GET['sync']) || $_GET['sync'] != 'update') {
    header("HTTP/1.0 404 Not Found");
    Header("Location: https://cgn.inf.br/eleicoes/");
    die();
}
